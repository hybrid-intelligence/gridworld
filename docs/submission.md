...
The evaluator will create an instance of `AIcrowdAgent` from `agents/aicrowd_wrapper.py` to run the evaluation. 
...
```bash
./submit.sh <description-phrase> # example: ./submit.sh my-first-agent 
```
...
```bash
cd iglu-2022-starter-kit

# Add AIcrowd git remote endpoint
git remote add aicrowd git@gitlab.aicrowd.com:<YOUR_AICROWD_USER_NAME>/iglu-2022-starter-kit.git 
...
`https://gitlab.aicrowd.com/<YOUR_AICROWD_USER_NAME>/iglu-2022-starter-kit/issues`
